...
export default function BriefCard({ item, briefId, index = 'nifty' }: { item: BriefItem; briefId: string; index?: string }) {
  return (
    ...
    >
      ...
      {item.historical_context && index === 'nifty' && <HistoricalBar text={item.historical_context} />}
